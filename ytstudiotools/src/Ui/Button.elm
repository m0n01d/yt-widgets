...
styleToClass style =
    case style of
        Primary ->
            "bg-red-600 border-red-600 text-white hover:bg-red-700 hover:border-red-700 shadow-md hover:shadow-lg"
        
        Secondary ->
            "bg-gray-800 border-gray-800 text-white hover:bg-gray-900 hover:border-gray-900 shadow-sm hover:shadow-md"
        
        Outline ->
            "bg-transparent border-gray-300 text-gray-700 hover:bg-gray-50 hover:text-gray-900"
        
        Text ->
            "bg-transparent border-transparent text-gray-700 hover:text-red-600 shadow-none hover:shadow-none"
