...
async function queryDomHelp(maybeUploadDialog, selector, n) {
  if (n < 0) {
  ...
  var maybeEl = Belt_Option.mapWithDefault(maybeUploadDialog, Caml_option.nullable_to_opt(document.querySelector(selector)), (function (dialog) {
  ...
  if (maybeEl !== undefined) {
    ...
    return await queryDomHelp(maybeUploadDialog, selector, n - 1 | 0);
  }
}
