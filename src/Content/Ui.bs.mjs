...
async function queryDom(maybeAncestorEl, selector, n) {
  if (n < 0) {
  ...
  var maybeEl = Belt_Option.mapWithDefault(maybeAncestorEl, Caml_option.nullable_to_opt(document.querySelector(selector)), (function (dialog) {
  ...
  if (maybeEl !== undefined) {
    ...
    return await queryDom(maybeAncestorEl, selector, n - 1 | 0);
  }
}
